        ...
        <div className="p-8 sm:p-12 flex flex-col justify-center">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-slate-800 p-3 rounded border-l-4 border-orange-500">
              <strong className="text-orange-400 block text-sm">
          ...
          <div className="relative z-10 w-full">
            <div className="bg-slate-800 p-4 rounded-xl border border-slate-600 mb-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <div className="text-slate-400 text-sm w-20">Temp: 0.5</div>
                  <div className="flex-1 h-2 bg-gradient-to-r from-blue-500 to-orange-500 rounded"></div>
                  <div className="text-xs text-slate-500">Balanced</div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="text-slate-400 text-sm w-20">Temp: 1.0</div>
                  <div className="flex-1 h-2 bg-orange-500 rounded animate-pulse"></div>
                  <div className="text-xs text-slate-500">Random</div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-slate-400 text-lg mb-6">
              Think of tokens as{" "}
              <strong className="text-sky-400">word pieces</strong>. Not exactly
              words, but close.
            </p>

            <div className="bg-slate-800 p-6 rounded-xl mb-6">
              <div className="text-sky-400 font-mono text-sm mb-2">
                Simple math:
              </div>
...
→ ~750 words`}
            ...
            <div className="bg-red-500/10 border border-red-500/50 p-4 rounded-lg mt-6">
    ...
    render: () => (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0 min-h-full -m-4 sm:-m-12">
        <div className="p-8 sm:p-12 flex flex-col justify-center">
          ...
          <div className="bg-slate-800 p-4 rounded-xl mb-4">
            ...
            <div className="bg-slate-950 p-3 rounded font-mono text-xs text-slate-300 space-y-1">
              ...
              <div className="text-red-400">User: Thanks! ← AI wrote this!</div>
            </div>
          </div>
        ...
        <div className="bg-slate-900 min-h-[300px] md:h-full p-8 md:p-12 flex items-center justify-center relative order-first md:order-last">
          <div className="relative z-10 w-full">
            <div className="space-y-4">
              <div className="bg-slate-800 p-4 rounded-xl border border-red-500/50">
                ...
                <div className="bg-slate-950 p-3 rounded text-xs font-mono space-y-1">
                  <div className="text-indigo-300">User: Tell me a joke</div>
                  ...
                  <div className="text-red-300">User: That's funny!</div>
                  <div className="text-red-300">AI: I'm glad you liked it!</div>
                </div>
              </div>
      ...
      <div className="min-h-full flex flex-col justify-center py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gradient-to-br from-indigo-900/50 to-slate-800/50 p-8 rounded-xl border border-indigo-500/30">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Few-Shot</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h4 className="text-red-400 font-bold">Zero-Shot</h4>
                <p className="text-xs text-slate-400">No examples</p>
              </div>
            </div>
...
"Sentiment: Negative"`}
            ...
            <p className="text-xs text-red-400 mt-3">⚠️ Inconsistent format!</p>
          </div>
          ...
          <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h4 className="text-yellow-400 font-bold">One-Shot</h4>
                <p className="text-xs text-slate-400">1 example</p>
              </div>
            </div>
...
✓ Format is better`}
          ...
          <div className="bg-green-900/20 border border-green-500/30 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="text-3xl">✅</div>
              <div>
                <h4 className="text-green-400 font-bold">Few-Shot</h4>
                <p className="text-xs text-slate-400">3+ examples</p>
              </div>
            </div>
      ...
      <div className="min-h-full flex flex-col justify-center py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="text-3xl">❌</div>
              <h3 className="text-red-400 font-bold text-xl">Without RAG</h3>
            </div>
          ...
          <div className="bg-green-900/20 border border-green-500/30 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="text-3xl">✅</div>
              <h3 className="text-green-400 font-bold text-xl">With RAG</h3>
            </div>
      ...
      <div className="min-h-full flex flex-col gap-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          <div className="bg-slate-800/50 border border-slate-600 rounded-xl p-5 space-y-3">
            <h4 className="text-sky-400 font-bold text-sm">Key Techniques</h4>
  ...
  // Slide 16.1: Real-World Pattern 2 (Tests) - Lab
  {
    ...
    render: () => (
      <div className="min-h-full flex flex-col gap-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          <div className="bg-slate-800/50 border border-slate-600 rounded-xl p-5 space-y-3">
            <h4 className="text-green-400 font-bold text-sm">Key Techniques</h4>
            <ul className="text-sm text-slate-300 space-y-2 list-disc list-inside">
    ...
    render: () => (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0 min-h-full -m-4 sm:-m-12">
        <div className="p-8 sm:p-12 flex flex-col gap-6 justify-center">
          ...
          <h3 className="text-3xl font-bold text-white">Reason + Act</h3>
